...
var orientdb = require('./connection');
...
module.exports = (function () {
    ...
    var getConn = function (config, collections) {
        return orientdb.create(config, collections);
    };
    ...
    var adapter = {
         ...
         *
         */
        //Gets the underlying oriento instance used by adapter
        ...
        //Executes the query using oriento's query method
